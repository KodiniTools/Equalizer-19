export const translations = {
  de: {
    ...
    feature_viz_app_title: 'Real-time Visualization',
    feature_viz_app_desc: 'Spektrum-Analyzer und Waveform-Darstellung',
    ...
    converter_desc:
      'Fur die Weiterverarbeitung deiner Aufnahmen (z. B. in andere Formate) nutze unseren Online-Audiokonverter. Offnet in einem neuen Tab.',
  ...
  en: {
    ...
    feature_viz_app_title: 'Real-time Visualization',
    feature_viz_app_desc: 'Spectrum analyzer and waveform visualization',
    main_title: 'EQUALIZER 19 – Vue 3 Edition',
    ...
    pro_tip: 'Pro Tip:',
    converter_desc:
      'For further processing of your recordings (e.g. to other formats), use our online audio converter. Opens in a new tab.',
