<template>
  <div class="recording-controls">
    ...
    <div class="recording-buttons">
      ...
      <!-- Stop Button -->
      <button v-if="isRecording" @click="handleStop" class="btn-stop">
        <i class="fas fa-stop"></i>
        <span>{{ currentLanguage === 'de' ? 'Aufnahme stoppen' : 'Stop Recording' }}</span>
      </button>

      <!-- Download Button -->
      <button v-if="hasRecording && !isRecording" @click="handleDownload" class="btn-download">
        <i class="fas fa-download"></i>
        <span>Download ({{ recordingFormat.toUpperCase() }})</span>
      </button>

      <!-- New Recording Button -->
      <button v-if="hasRecording && !isRecording" @click="handleNewRecording" class="btn-new">
...
<script setup>
  ...
  async function handleStart() {
    ...
    if (success) {
      notify(currentLanguage.value === 'de' ? 'Aufnahme gestartet' : 'Recording started', 'success')
    } else {
      errorMessage.value =
  ...
  function handleStop() {
    stopRecording()
    notify(currentLanguage.value === 'de' ? 'Aufnahme gestoppt' : 'Recording stopped', 'info')
  }

  function handleDownload() {
    downloadRecording()
    notify(currentLanguage.value === 'de' ? 'Download gestartet' : 'Download started', 'success')
  }
  ...
  function handleNewRecording() {
    ...
    notify(
      currentLanguage.value === 'de' ? 'Bereit für neue Aufnahme' : 'Ready for new recording',
      'info'
    )
  }
</script>
